...
namespace Mirror
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        //START MODIFIED CODE   
        public void StartClient(string ManualAddress)
        {
            ...
            // Debug.Log($"NetworkManager StartClient address:{ManualAddress}");

            NetworkClient.Connect(ManualAddress);
