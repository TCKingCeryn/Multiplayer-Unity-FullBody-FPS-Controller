...
#if UNITY_EDITOR
    [CustomEditor(typeof(FPSArmsController))]
    public class CustomInspectorFPSCameraController : Editor
    {
        public override void OnInspectorGUI()
        {
            DrawDefaultInspector();

            FPSArmsController FPSArmsController = (FPSArmsController)target;
            ...
            {
                FPSArmsController.HandleLockBones();
            }
