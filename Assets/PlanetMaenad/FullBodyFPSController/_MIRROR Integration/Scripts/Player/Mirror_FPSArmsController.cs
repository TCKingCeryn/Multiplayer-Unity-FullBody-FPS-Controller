...
#if UNITY_EDITOR
    [CustomEditor(typeof(Mirror_FPSArmsController))]
    public class CustomInspectorMirror_FPSCameraController : Editor
    {
        public override void OnInspectorGUI()
        {
            DrawDefaultInspector();

            Mirror_FPSArmsController Mirror_FPSArmsController = (Mirror_FPSArmsController)target;
