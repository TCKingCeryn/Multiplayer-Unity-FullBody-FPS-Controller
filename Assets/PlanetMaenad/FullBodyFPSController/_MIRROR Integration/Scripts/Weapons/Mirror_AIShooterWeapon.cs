...
namespace PlanetMaenad.FPS
{
    ...
    public class Mirror_AIShooterWeapon : Mirror_AIWeapon
    {
        ...
        void spawnBullet()
        {
            ...
            if (UseRigidbodyBullet && Bullet)
            {
                ...
                tempBullet.GetComponent<Mirror_RegisterDamageHit>().Damage = Damage;
        ...
        //{
        //    if (other != null && other.GetComponentInParent<Mirror_HealthController>())
        //    {
