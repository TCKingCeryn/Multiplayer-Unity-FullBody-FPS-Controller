...
{
    [AddComponentMenu("")]
    public class MAIN_ChatAuthenticator : NetworkAuthenticator
    {
        ...
        public void OnAuthRequestMessage(NetworkConnectionToClient conn, AuthRequestMessage msg)
        {
            ...
            if (!Mirror_MasterPlayerController.playerNames.Contains(msg.authUsername))
            {
                // Add the name to the HashSet
                Mirror_MasterPlayerController.playerNames.Add(msg.authUsername);
            ...
            {
                // Add the name to the HashSet
                Mirror_MasterPlayerController.playerNames.Add(msg.authUsername + "_1");
                playerName = playerName + "_1";

                // Store username in authenticationData
                // This will be read in Player.OnStartServer
                // to set the playerName SyncVar.
                conn.authenticationData = msg.authUsername + "_1";
        ...
        {
            playerName = username;
            //PortLoginUI.instance.errorText.text = string.Empty;
            //PortLoginUI.instance.errorText.gameObject.SetActive(false);
        }
        ...
        public void OnAuthResponseMessage(AuthResponseMessage msg)
        {
            ...
            else
            {
                ...
                //PortLoginUI.instance.errorText.text = msg.message;
                //PortLoginUI.instance.errorText.gameObject.SetActive(true);
            }
        }
