...
[AddComponentMenu("")]
public class TEST_ChatAuthenticator : NetworkAuthenticator
{
    ...
    public void OnAuthRequestMessage(NetworkConnectionToClient conn, AuthRequestMessage msg)
    {
        ...
        if (!TEST_SimplePlayer.playerNames.Contains(msg.authUsername))
        {
            // Add the name to the HashSet
            TEST_SimplePlayer.playerNames.Add(msg.authUsername);
        ...
        {
            // Add the name to the HashSet
            TEST_SimplePlayer.playerNames.Add(msg.authUsername + "_1");
